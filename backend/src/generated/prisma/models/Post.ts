...
export type PostCreatephotosUrlInput = {
  set: string[]
}
...
export type PostUpdatephotosUrlInput = {
  set?: string[]
  push?: string | string[]
}
...
export type PostOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "content" | "published" | "photosUrl" | "videosUrl" | "authorId" | "createdAt" | "updatedAt", ExtArgs["result"]["post"]>
...
export interface PostFieldRefs {
  ...
  readonly photosUrl: Prisma.FieldRef<"Post", 'String[]'>
  readonly videosUrl: Prisma.FieldRef<"Post", 'String'>
